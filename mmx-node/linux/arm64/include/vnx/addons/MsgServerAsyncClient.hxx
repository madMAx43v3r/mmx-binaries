...
#ifndef INCLUDE_vnx_addons_MsgServer_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_addons_MsgServer_ASYNC_CLIENT_HXX_
...
class MsgServerAsyncClient : public vnx::AsyncClient {
public:
	MsgServerAsyncClient(const std::string& service_name);
	
	MsgServerAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_addons_MsgServer_ASYNC_CLIENT_HXX_
