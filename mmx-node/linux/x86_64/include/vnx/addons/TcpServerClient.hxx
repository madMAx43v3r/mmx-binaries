...
#ifndef INCLUDE_vnx_addons_TcpServer_CLIENT_HXX_
#define INCLUDE_vnx_addons_TcpServer_CLIENT_HXX_
...
class TcpServerClient : public vnx::Client {
public:
	TcpServerClient(const std::string& service_name);
	
	TcpServerClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_addons_TcpServer_CLIENT_HXX_
