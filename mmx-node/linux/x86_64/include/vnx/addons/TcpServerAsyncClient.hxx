...
#ifndef INCLUDE_vnx_addons_TcpServer_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_addons_TcpServer_ASYNC_CLIENT_HXX_
...
class TcpServerAsyncClient : public vnx::AsyncClient {
public:
	TcpServerAsyncClient(const std::string& service_name);
	
	TcpServerAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_addons_TcpServer_ASYNC_CLIENT_HXX_
